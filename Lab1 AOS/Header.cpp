...
double IntType::addition(){
    int a1=111, a2=22, a3=333, a4=4444, a5=555, a6=666,
        a7=77, a8=888888, a9=9999999, a10=101;
    clock_t t1 = clock();
    for (long i = 10; i < ITERATIONS; i++) {
        a1 = 11 % i + 1; a2 = 222 % i + 1;
        a3 = a2 + a1; a4 = a3 + a2; a5 = a4 + a3;
        a6 = a5 + a4; a7 = a6 + a5; a8 = a7 + a6;
        a9 = a8 + a7; a10 = a8 + a9; a1 = a10 + a9; a2 = a1 + a10;
...
double IntType::empty() {
    int a1=111, a2=22, a3=333, a4=4444, a5=555,
        a6=666, a7=77, a8=888888, a9=9999999, a10=101;
    clock_t t1 = clock();
    for (long i = 10; i < ITERATIONS; i++) {
        a1 = 111 % i + 1; a2 = 22 % i + 1;
        a3 = 333; a4 = 4444; a5 = 555; a6 = 666;
        a7 = 77; a8 = 888888; a9 = 9999999; a10 = 101;
    }
    clock_t t2 = clock();
    double time = t2 - t1;
...
double CharType::division(){
    ...
    for (int i = 10; i < 10000000; i++) {
        ...
        a7 = a6 / a5; while (a7 == 0) a7 = rand();
        a8 = a6 / a7; while (a8 == 0) a8 = rand();
        a9 = a7 / a8; while (a9 == 0) a9 = rand();
        a10 = a8 / a9; while (a10 == 0) a10 = rand();
        a1 = a9 / a10; while (a1 == 0) a1 = rand();
        a2 = a10/ a9; while (a2 == 0) a2 = rand();
    }
    clock_t t2 = clock();
    double time = t2 - t1;
    return time;
